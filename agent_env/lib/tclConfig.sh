...
# installed.
TCL_PREFIX='/data1/sandeep_projects/agentic/agent_env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/data1/sandeep_projects/agentic/agent_env'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /data1/sandeep_projects/agentic/agent_env/include -fdebug-prefix-map=/croot/tk_1755243777296/work=/usr/local/src/conda/tk-8.6.15 -fdebug-prefix-map=/data1/sandeep_projects/agentic/agent_env=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /data1/sandeep_projects/agentic/agent_env/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/data1/sandeep_projects/agentic/agent_env/lib -Wl,-rpath-link,/data1/sandeep_projects/agentic/agent_env/lib -L/data1/sandeep_projects/agentic/agent_env/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/data1/sandeep_projects/agentic/agent_env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/data1/sandeep_projects/agentic/agent_env/include'
...
TCL_PACKAGE_PATH='/data1/sandeep_projects/agentic/agent_env/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/data1/sandeep_projects/agentic/agent_env/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1755243777296/work/tcl8.6.15/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/data1/sandeep_projects/agentic/agent_env/lib/libtclstub8.6.a'
